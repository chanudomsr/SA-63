...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async getCheckoutRaw(requestParameters: GetCheckoutRequest): Promise<runtime.ApiResponse<ControllersCheckout>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ControllersCheckoutFromJSON(jsonValue));
    }
     ...
     * Get a checkout entity by ID
     */
    async getCheckout(requestParameters: GetCheckoutRequest): Promise<ControllersCheckout> {
