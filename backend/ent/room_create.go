...
func (rc *RoomCreate) SetCheckout3ID(id int) *RoomCreate {
	rc.mutation.SetCheckout3ID(id)
	return rc
}

// SetNillableCheckout3ID sets the checkout3 edge to Checkout by id if the given value is not nil.
func (rc *RoomCreate) SetNillableCheckout3ID(id *int) *RoomCreate {
	if id != nil {
		rc = rc.SetCheckout3ID(*id)
	}
	return rc
}

// SetCheckout3 sets the checkout3 edge to Checkout.
func (rc *RoomCreate) SetCheckout3(c *Checkout) *RoomCreate {
	return rc.SetCheckout3ID(c.ID)
}
...
func (rc *RoomCreate) createSpec() (*Room, *sqlgraph.CreateSpec) {
	...
	if nodes := rc.mutation.Checkout3IDs(); len(nodes) > 0 {
