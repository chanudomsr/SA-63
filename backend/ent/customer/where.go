...
func HasCheckout1() predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Checkout1Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, Checkout1Table, Checkout1Column),
		)
...
func HasCheckout1With(preds ...predicate.Checkout) predicate.Customer {
	return predicate.Customer(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
