...
// QueryCheckout1 queries the checkout1 edge of a Customer.
func (c *CustomerClient) QueryCheckout1(cu *Customer) *CheckoutQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, customer.Checkout1Table, customer.Checkout1Column),
		)
...
// QueryCheckout2 queries the checkout2 edge of a Employee.
func (c *EmployeeClient) QueryCheckout2(e *Employee) *CheckoutQuery {
	query := &CheckoutQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := e.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(checkout.Table, checkout.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, employee.Checkout2Table, employee.Checkout2Column),
		)
...
// QueryCheckout3 queries the checkout3 edge of a Room.
func (c *RoomClient) QueryCheckout3(r *Room) *CheckoutQuery {
	query := &CheckoutQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(checkout.Table, checkout.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, room.Checkout3Table, room.Checkout3Column),
		)
