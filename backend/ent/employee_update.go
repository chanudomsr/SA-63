...
func (eu *EmployeeUpdate) AddCheckout2IDs(ids ...int) *EmployeeUpdate {
	eu.mutation.AddCheckout2IDs(ids...)
	return eu
}

// AddCheckout2 adds the checkout2 edges to Checkout.
func (eu *EmployeeUpdate) AddCheckout2(c ...*Checkout) *EmployeeUpdate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return eu.AddCheckout2IDs(ids...)
}
...
func (eu *EmployeeUpdate) RemoveCheckout2IDs(ids ...int) *EmployeeUpdate {
	eu.mutation.RemoveCheckout2IDs(ids...)
	return eu
}

// RemoveCheckout2 removes checkout2 edges to Checkout.
func (eu *EmployeeUpdate) RemoveCheckout2(c ...*Checkout) *EmployeeUpdate {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return eu.RemoveCheckout2IDs(ids...)
}
...
func (eu *EmployeeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := eu.mutation.RemovedCheckout2IDs(); len(nodes) > 0 {
	...
	if nodes := eu.mutation.Checkout2IDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   employee.Checkout2Table,
...
// AddCheckout2IDs adds the checkout2 edge to Checkout by ids.
func (euo *EmployeeUpdateOne) AddCheckout2IDs(ids ...int) *EmployeeUpdateOne {
	euo.mutation.AddCheckout2IDs(ids...)
	return euo
}

// AddCheckout2 adds the checkout2 edges to Checkout.
func (euo *EmployeeUpdateOne) AddCheckout2(c ...*Checkout) *EmployeeUpdateOne {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return euo.AddCheckout2IDs(ids...)
}
...
// RemoveCheckout2IDs removes the checkout2 edge to Checkout by ids.
func (euo *EmployeeUpdateOne) RemoveCheckout2IDs(ids ...int) *EmployeeUpdateOne {
	euo.mutation.RemoveCheckout2IDs(ids...)
	return euo
}

// RemoveCheckout2 removes checkout2 edges to Checkout.
func (euo *EmployeeUpdateOne) RemoveCheckout2(c ...*Checkout) *EmployeeUpdateOne {
	ids := make([]int, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return euo.RemoveCheckout2IDs(ids...)
}
...
func (euo *EmployeeUpdateOne) sqlSave(ctx context.Context) (e *Employee, err error) {
	...
	if nodes := euo.mutation.RemovedCheckout2IDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   employee.Checkout2Table,
	...
	if nodes := euo.mutation.Checkout2IDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   employee.Checkout2Table,
