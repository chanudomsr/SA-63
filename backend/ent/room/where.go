...
func HasCheckout3() predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(Checkout3Table, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, Checkout3Table, Checkout3Column),
		)
...
func HasCheckout3With(preds ...predicate.Checkout) predicate.Room {
	return predicate.Room(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
