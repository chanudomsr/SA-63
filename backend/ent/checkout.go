...
type Checkout struct {
	...
	customer_checkout1 *int
	employee_checkout2 *int
	room_checkout3     *int
}
...
func (*Checkout) fkValues() []interface{} {
	return []interface{}{
		&sql.NullInt64{}, // customer_checkout1
		&sql.NullInt64{}, // employee_checkout2
		&sql.NullInt64{}, // room_checkout3
	}
}
...
func (c *Checkout) assignValues(values ...interface{}) error {
	...
	if len(values) == len(checkout.ForeignKeys) {
		if value, ok := values[0].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field customer_checkout1", value)
		} else if value.Valid {
			c.customer_checkout1 = new(int)
			*c.customer_checkout1 = int(value.Int64)
		}
		if value, ok := values[1].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field employee_checkout2", value)
		} else if value.Valid {
			c.employee_checkout2 = new(int)
			*c.employee_checkout2 = int(value.Int64)
		}
		if value, ok := values[2].(*sql.NullInt64); !ok {
			return fmt.Errorf("unexpected type %T for edge-field room_checkout3", value)
		} else if value.Valid {
			c.room_checkout3 = new(int)
			*c.room_checkout3 = int(value.Int64)
		}
	}
	return nil
}
