...
func (e RoomEdges) Checkout3OrErr() (*Checkout, error) {
	if e.loadedTypes[0] {
		if e.Checkout3 == nil {
			// The edge checkout3 was loaded in eager-loading,
			// but was not found.
...
// QueryCheckout3 queries the checkout3 edge of the Room.
func (r *Room) QueryCheckout3() *CheckoutQuery {
	return (&RoomClient{config: r.config}).QueryCheckout3(r)
}
